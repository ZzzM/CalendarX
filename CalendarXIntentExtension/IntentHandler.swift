...
@MainActor
extension IntentHandler: @preconcurrency WidgetConfigurationIntentHandling {
...
extension IntentHandler {
    func provideLightAccentColorOptionsCollection(for intent: WidgetConfigurationIntent) async throws
        -> INObjectCollection<WidgetColor>
    {
        let items = Bundle.lightAccent.map(intent.colorItem)
        return INObjectCollection(items: items)
    }

    func provideLightBackgroundColorOptionsCollection(for intent: WidgetConfigurationIntent) async throws
        -> INObjectCollection<WidgetColor>
    {
    ...
    func provideDarkAccentColorOptionsCollection(for intent: WidgetConfigurationIntent) async throws
        -> INObjectCollection<WidgetColor>
    {
    ...
    func provideDarkBackgroundColorOptionsCollection(for intent: WidgetConfigurationIntent) async throws
        -> INObjectCollection<WidgetColor>
    {
